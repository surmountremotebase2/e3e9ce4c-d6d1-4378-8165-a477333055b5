...
class TradingStrategy(Strategy):
   ...
   # Calculate MA values
   data['MA'] = ma(data['Close'], MA_PERIOD, MA_TYPE)
   data['SSL1_High'] = ma(data['High'], MA_PERIOD, MA_TYPE)
   data['SSL1_Low'] = ma(data['Low'], MA_PERIOD, MA_TYPE)
   data['SSL2_High'] = ma(data['High'], SSL2_PERIOD, 'JMA')  # Example using 'JMA' for SSL2
   data['SSL2_Low'] = ma(data['Low'], SSL2_PERIOD, 'JMA')
   data['SSL3_High'] = ma(data['High'], SSL3_PERIOD, 'HMA')  # Example using 'HMA' for SSL3
   data['SSL3_Low'] = ma(data['Low'], SSL3_PERIOD, 'HMA')
